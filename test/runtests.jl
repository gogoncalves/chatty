...
# !!! Main.UserApp is configured as an alias for Main.Chatty and you might encounter it in some tests
using Main.Chatty, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Chatty tests" begin
  @includetests ARGS
end
